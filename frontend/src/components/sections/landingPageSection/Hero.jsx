const Hero = () => {
  return (
    <>
      <section className="relative h-[90vh] bg-[url('/heroBg.png')] bg-cover flex bg-center px-6">
      <div className="absolute inset-0 bg-gradient-to-b from-[#FFEDD5]/40 to-[#F87171]/20"></div>
        <div className="flex gap-4 flex-col w-[60vw] py-8 mx-auto text-center items-center">
          ...
          <button className="bg-[#F22F1D] hover:bg-[#F24F13] text-white px-10 py-3 rounded-full text-lg font-bold shadow-lg hover:shadow-xl transition"> Get Started for Free
         </button>
          </div>
        </div>
      </section>
